...
class CategoryView(APIView):
    ...
    def get(self, request):
        ...
        category_list_serialized = CategorySerializer(
...
class CategoryItemView(APIView):
    ...
    def get(self, request, category_id):
        try:
            category_item = Category.objects.get(
        ...
        category_item_serializer = CategorySerializer(
            category_item, many=False
        )
    ...
    def put(self, request, category_id):
        ...
        category_data = CategorySerializer(
            instance=category_item, data=request.data
        )
        category_data.is_valid(raise_exception=True)
        try:
            category_data.save()
